...
class ItemListTempWeek extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DateFormat formatDay = DateFormat.E('pt_BR');
    DateFormat formatDatum = DateFormat('dd/MM');
    DateTime dataReceived = DateTime.parse(data);
    String dataFormatted = formatDay.format(dataReceived);
